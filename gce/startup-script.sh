...
git clone --single-branch --branch feature-gce-trends-sentiment-endpoint https://github.com/CUBigDataClass/BigMood-SentimentAnalyzer.git /opt/app
...
python3 /opt/app/application.py
